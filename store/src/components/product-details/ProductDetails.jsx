                    ...
                    <aside className="col-md-6">
                        <article className="gallery-wrap">
                            ...
                            <div className="thumbs-wrap">
                                <a href="#" className="item-thumb"> <img src="../../pages/images/items/12-1.jpg"/></a>
                                <a href="#" className="item-thumb"> <img src="../../pages/images/items/12-2.jpg"/></a>
                                <a href="#" className="item-thumb"> <img src="../../pages/images/items/12.jpg"/></a>
                                <a href="#" className="item-thumb"> <img src="../../pages/images/items/4.jpg"/></a>
                            </div>
                        </article>
                    </aside>
